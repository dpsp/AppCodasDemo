...
//        let scriptContent = String(contentsOfFile:scriptURL!, encoding:NSUTF8StringEncoding, error: nil)
        ...
        var scriptContent = ""
        do {
            scriptContent = try String(contentsOfFile:scriptURL!)
        }
    ...
    override func viewDidLoad() {
        ...
        webView.loadRequest(NSURLRequest(URL:NSURL(string:"http://i.ifeng.com/auto/autoi?ch=ifengweb")!))
...
//        let scriptContent =
    ...
    func webView(webView: WKWebView, decidePolicyForNavigationAction navigationAction: WKNavigationAction, decisionHandler: ((WKNavigationActionPolicy) -> Void)) {
        if (navigationAction.navigationType == WKNavigationType.LinkActivated && !(navigationAction.request.URL!.host!.lowercaseString.hasPrefix("i.auto.ifeng.com") || navigationAction.request.URL!.host!.lowercaseString.hasPrefix("i.ifeng.com"))) {
